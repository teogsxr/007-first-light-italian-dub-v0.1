...
- `https://teogsxr.github.io/007-first-light-italian-dub-v0.1/`

Current public release:

- `https://github.com/teogsxr/007-first-light-italian-dub-v0.1/releases/tag/v0.2`
...
To rebuild the v0.2 package from local production state:
...
git status -sb
git add -A
git commit -m "Publish v0.2 release package"
git push
git tag v0.2
git push origin v0.2
gh release create v0.2 ..\007-first-light-italian-dub-v0.2.zip --title "007 First Light Italian Dub v0.2" --notes-file RELEASE_NOTES.md
```

If the release already exists:

```powershell
gh release upload v0.2 ..\007-first-light-italian-dub-v0.2.zip --clobber
gh release edit v0.2 --title "007 First Light Italian Dub v0.2" --notes-file RELEASE_NOTES.md
```
